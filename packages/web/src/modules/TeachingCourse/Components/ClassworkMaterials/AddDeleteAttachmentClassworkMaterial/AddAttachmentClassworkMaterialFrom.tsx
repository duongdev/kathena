...
import { AddAttachmentsFormInput } from './AddAttachmentClassworkMaterial'

export type AddMaterialsFormProps = {}

const AddMaterialsForm: FC<AddMaterialsFormProps> = (props) => {
