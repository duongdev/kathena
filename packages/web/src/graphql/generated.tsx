...
export type AddFilesToClassworkSubmissionInput = {
  submissionFiles: Array<Scalars['Upload']>
}
...
export type Lesson = BaseModel & {
  ...
  orgId: Scalars['ID']
  publicationState: Publication
  quizListAfterClass?: Maybe<Array<Scalars['ID']>>
  quizListBeforeClass?: Maybe<Array<Scalars['ID']>>
  quizListInClass?: Maybe<Array<Scalars['ID']>>
  startTime: Scalars['DateTime']
  updatedAt: Scalars['DateTime']
...
export type Mutation = {
  ...
  addFilesToClassworkSubmission: ClassworkSubmission
  ...
  publishAllClassworkAssignmentsOfTheCourse: Array<ClassworkAssignment>
  publishAllClassworkMaterialsOfTheCourse: Array<ClassworkMaterial>
  publishAllLessonsOfTheCourse: Array<Lesson>
  publishAllQuizOfTheCourse: Array<Quiz>
  ...
  removeFilesFromClassworkSubmission: ClassworkSubmission
  ...
  updateClassworkSubmission: ClassworkSubmission
  updateCourse: Course
...
export type MutationAddFilesToClassworkSubmissionArgs = {
...
export type MutationPublishAllClassworkAssignmentsOfTheCourseArgs = {
  courseId: Scalars['ID']
}

export type MutationPublishAllClassworkMaterialsOfTheCourseArgs = {
  courseId: Scalars['ID']
}

export type MutationPublishAllLessonsOfTheCourseArgs = {
  courseId: Scalars['ID']
}

export type MutationPublishAllQuizOfTheCourseArgs = {
  courseId: Scalars['ID']
}
...
export type MutationRemoveFilesFromClassworkSubmissionArgs = {
  classworkSubmissionId: Scalars['ID']
  submissionFilesInput?: Maybe<Array<Scalars['String']>>
}
...
export type MutationUpdateClassworkSubmissionArgs = {
  classworkAssignmentId: Scalars['ID']
...
export type UpdateClassworkSubmissionInput = {
  description?: Maybe<Scalars['String']>
}
...
export type UpdateLessonInput = {
  ...
  publicationState?: Maybe<Publication>
  quizListAfterClass?: Maybe<Array<Scalars['String']>>
  quizListBeforeClass?: Maybe<Array<Scalars['String']>>
  quizListInClass?: Maybe<Array<Scalars['String']>>
  startTime?: Maybe<Scalars['DateTime']>
}
...
export type NotificationSubscription = { notification: { title: string } }
...
export type SubmissionStatusStatisticsQueryVariables = Exact<{
  id: Scalars['ID']
}>

export type SubmissionStatusStatisticsQuery = {
...
export type CreateRatingForTheLessonMutationVariables = Exact<{
  ratingInput: RatingInput
}>

export type CreateRatingForTheLessonMutation = {
  createRatingForTheLesson: {
    id: string
    orgId: string
    createdAt: any
    updatedAt: any
...
export type FindLessonByIdQuery = {
  findLessonById: {
    ...
    quizListAfterClass?: Array<string> | null | undefined
    quizListInClass?: Array<string> | null | undefined
    quizListBeforeClass?: Array<string> | null | undefined
  }
}
...
export type PublishAllLessonsOfTheCourseMutationVariables = Exact<{
  courseId: Scalars['ID']
}>

export type PublishAllLessonsOfTheCourseMutation = {
  publishAllLessonsOfTheCourse: Array<{ id: string; courseId: string }>
}
...
export type PublishAllClassworkMaterialsOfTheCourseMutationVariables = Exact<{
  courseId: Scalars['ID']
}>

export type PublishAllClassworkMaterialsOfTheCourseMutation = {
  publishAllClassworkMaterialsOfTheCourse: Array<{
    id: string
    courseId: string
  }>
}
...
export type PublishAllQuizOfTheCourseMutationVariables = Exact<{
  courseId: Scalars['ID']
}>

export type PublishAllQuizOfTheCourseMutation = {
  publishAllQuizOfTheCourse: Array<{ id: string; courseId: string }>
}
...
export type ListClassworkSubmissionQueryResult = Apollo.QueryResult<
  ...
  ListClassworkSubmissionQueryVariables
>
export const SubmissionStatusStatisticsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'SubmissionStatusStatistics' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
...
export type SubmissionStatusStatisticsProps<
  TChildProps = {},
  TDataName extends string = 'data',
> = {
  [key in TDataName]: ApolloReactHoc.DataValue<
...
>(
  operationOptions?: ApolloReactHoc.OperationOption<
    ...
    SubmissionStatusStatisticsQuery,
    SubmissionStatusStatisticsQueryVariables,
    SubmissionStatusStatisticsProps<TChildProps, TDataName>
  >,
) {
  return ApolloReactHoc.withQuery<
    TProps,
    ...
    SubmissionStatusStatisticsQueryVariables,
    SubmissionStatusStatisticsProps<TChildProps, TDataName>
  >(SubmissionStatusStatisticsDocument, {
    alias: 'submissionStatusStatistics',
    ...operationOptions,
  })
}

/**
 * __useSubmissionStatusStatisticsQuery__
 *
 * To run a query within a React component, call `useSubmissionStatusStatisticsQuery` and pass it any options that fit your needs.
 * When your component renders, `useSubmissionStatusStatisticsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useSubmissionStatusStatisticsQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useSubmissionStatusStatisticsQuery(
  baseOptions: Apollo.QueryHookOptions<
    SubmissionStatusStatisticsQuery,
    SubmissionStatusStatisticsQueryVariables
  >,
  ...
  return Apollo.useQuery<
    SubmissionStatusStatisticsQuery,
    SubmissionStatusStatisticsQueryVariables
  >(SubmissionStatusStatisticsDocument, options)
}
export function useSubmissionStatusStatisticsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    SubmissionStatusStatisticsQuery,
    SubmissionStatusStatisticsQueryVariables
  >,
...
export type SubmissionStatusStatisticsQueryHookResult = ReturnType<
  typeof useSubmissionStatusStatisticsQuery
>
export type SubmissionStatusStatisticsLazyQueryHookResult = ReturnType<
  typeof useSubmissionStatusStatisticsLazyQuery
>
export type SubmissionStatusStatisticsQueryResult = Apollo.QueryResult<
  SubmissionStatusStatisticsQuery,
  SubmissionStatusStatisticsQueryVariables
>
...
export type SubmitQuizMutationOptions = Apollo.BaseMutationOptions<
  ...
  SubmitQuizMutationVariables
>
export const CreateRatingForTheLessonDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'CreateRatingForTheLesson' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
            kind: 'Variable',
            name: { kind: 'Name', value: 'ratingInput' },
          },
          type: {
            kind: 'NonNullType',
            type: {
...
export type CreateRatingForTheLessonMutationFn = Apollo.MutationFunction<
  CreateRatingForTheLessonMutation,
  CreateRatingForTheLessonMutationVariables
>
export type CreateRatingForTheLessonProps<
  TChildProps = {},
  TDataName extends string = 'mutate',
> = {
  [key in TDataName]: Apollo.MutationFunction<
...
>(
  operationOptions?: ApolloReactHoc.OperationOption<
    ...
    CreateRatingForTheLessonMutation,
    CreateRatingForTheLessonMutationVariables,
    CreateRatingForTheLessonProps<TChildProps, TDataName>
  >,
) {
  return ApolloReactHoc.withMutation<
    TProps,
    ...
    CreateRatingForTheLessonMutationVariables,
    CreateRatingForTheLessonProps<TChildProps, TDataName>
  >(CreateRatingForTheLessonDocument, {
    alias: 'createRatingForTheLesson',
    ...operationOptions,
  })
}

/**
 * __useCreateRatingForTheLessonMutation__
 *
 * To run a mutation, you first call `useCreateRatingForTheLessonMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateRatingForTheLessonMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [createRatingForTheLessonMutation, { data, loading, error }] = useCreateRatingForTheLessonMutation({
 *   variables: {
 *      ratingInput: // value for 'ratingInput'
 *   },
 * });
 */
export function useCreateRatingForTheLessonMutation(
  baseOptions?: Apollo.MutationHookOptions<
    CreateRatingForTheLessonMutation,
    CreateRatingForTheLessonMutationVariables
  >,
  ...
  return Apollo.useMutation<
    CreateRatingForTheLessonMutation,
    CreateRatingForTheLessonMutationVariables
  >(CreateRatingForTheLessonDocument, options)
}
export type CreateRatingForTheLessonMutationHookResult = ReturnType<
  typeof useCreateRatingForTheLessonMutation
>
export type CreateRatingForTheLessonMutationResult =
  Apollo.MutationResult<CreateRatingForTheLessonMutation>
export type CreateRatingForTheLessonMutationOptions =
  Apollo.BaseMutationOptions<
    CreateRatingForTheLessonMutation,
    CreateRatingForTheLessonMutationVariables
  >
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'quizListAfterClass' },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'quizListInClass' },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'quizListBeforeClass' },
                },
              ],
            },
          },
...
export type UpdateLessonMutationOptions = Apollo.BaseMutationOptions<
  ...
  UpdateLessonMutationVariables
>
export const PublishAllLessonsOfTheCourseDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'PublishAllLessonsOfTheCourse' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
...
export type PublishAllLessonsOfTheCourseMutationFn = Apollo.MutationFunction<
  PublishAllLessonsOfTheCourseMutation,
  PublishAllLessonsOfTheCourseMutationVariables
>
export type PublishAllLessonsOfTheCourseProps<
  TChildProps = {},
  TDataName extends string = 'mutate',
> = {
  [key in TDataName]: Apollo.MutationFunction<
...
export function withPublishAllLessonsOfTheCourse<
  TProps,
  TChildProps = {},
  TDataName extends string = 'mutate',
>(
  operationOptions?: ApolloReactHoc.OperationOption<
    ...
    PublishAllLessonsOfTheCourseMutation,
    PublishAllLessonsOfTheCourseMutationVariables,
    PublishAllLessonsOfTheCourseProps<TChildProps, TDataName>
  >,
) {
  return ApolloReactHoc.withMutation<
    TProps,
    ...
    PublishAllLessonsOfTheCourseMutationVariables,
    PublishAllLessonsOfTheCourseProps<TChildProps, TDataName>
  >(PublishAllLessonsOfTheCourseDocument, {
    alias: 'publishAllLessonsOfTheCourse',
    ...operationOptions,
  })
}

/**
 * __usePublishAllLessonsOfTheCourseMutation__
 *
 * To run a mutation, you first call `usePublishAllLessonsOfTheCourseMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `usePublishAllLessonsOfTheCourseMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [publishAllLessonsOfTheCourseMutation, { data, loading, error }] = usePublishAllLessonsOfTheCourseMutation({
 *   variables: {
 *      courseId: // value for 'courseId'
 *   },
 * });
 */
export function usePublishAllLessonsOfTheCourseMutation(
  baseOptions?: Apollo.MutationHookOptions<
    PublishAllLessonsOfTheCourseMutation,
    PublishAllLessonsOfTheCourseMutationVariables
  >,
  ...
  return Apollo.useMutation<
    PublishAllLessonsOfTheCourseMutation,
    PublishAllLessonsOfTheCourseMutationVariables
  >(PublishAllLessonsOfTheCourseDocument, options)
}
export type PublishAllLessonsOfTheCourseMutationHookResult = ReturnType<
  typeof usePublishAllLessonsOfTheCourseMutation
>
export type PublishAllLessonsOfTheCourseMutationResult =
  Apollo.MutationResult<PublishAllLessonsOfTheCourseMutation>
export type PublishAllLessonsOfTheCourseMutationOptions =
  Apollo.BaseMutationOptions<
    PublishAllLessonsOfTheCourseMutation,
    PublishAllLessonsOfTheCourseMutationVariables
  >
...
export type RemoveVideoFromClassworkMaterialMutationOptions =
  Apollo.BaseMutationOptions<
    ...
    RemoveVideoFromClassworkMaterialMutationVariables
  >
export const PublishAllClassworkMaterialsOfTheCourseDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'PublishAllClassworkMaterialsOfTheCourse' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
        ...
        selections: [
          {
            ...
            name: {
              kind: 'Name',
              value: 'publishAllClassworkMaterialsOfTheCourse',
            },
            arguments: [
              {
                kind: 'Argument',
...
export type PublishAllClassworkMaterialsOfTheCourseMutationFn =
  Apollo.MutationFunction<
    PublishAllClassworkMaterialsOfTheCourseMutation,
    PublishAllClassworkMaterialsOfTheCourseMutationVariables
  >
export type PublishAllClassworkMaterialsOfTheCourseProps<
  TChildProps = {},
  TDataName extends string = 'mutate',
> = {
  [key in TDataName]: Apollo.MutationFunction<
...
export function withPublishAllClassworkMaterialsOfTheCourse<
  TProps,
  TChildProps = {},
  TDataName extends string = 'mutate',
>(
  operationOptions?: ApolloReactHoc.OperationOption<
    ...
    PublishAllClassworkMaterialsOfTheCourseMutation,
    PublishAllClassworkMaterialsOfTheCourseMutationVariables,
    PublishAllClassworkMaterialsOfTheCourseProps<TChildProps, TDataName>
  >,
) {
  return ApolloReactHoc.withMutation<
    TProps,
    ...
    PublishAllClassworkMaterialsOfTheCourseMutationVariables,
    PublishAllClassworkMaterialsOfTheCourseProps<TChildProps, TDataName>
  >(PublishAllClassworkMaterialsOfTheCourseDocument, {
    alias: 'publishAllClassworkMaterialsOfTheCourse',
    ...operationOptions,
  })
}

/**
 * __usePublishAllClassworkMaterialsOfTheCourseMutation__
 *
 * To run a mutation, you first call `usePublishAllClassworkMaterialsOfTheCourseMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `usePublishAllClassworkMaterialsOfTheCourseMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [publishAllClassworkMaterialsOfTheCourseMutation, { data, loading, error }] = usePublishAllClassworkMaterialsOfTheCourseMutation({
 *   variables: {
 *      courseId: // value for 'courseId'
 *   },
 * });
 */
export function usePublishAllClassworkMaterialsOfTheCourseMutation(
  baseOptions?: Apollo.MutationHookOptions<
    PublishAllClassworkMaterialsOfTheCourseMutation,
    PublishAllClassworkMaterialsOfTheCourseMutationVariables
  >,
  ...
  return Apollo.useMutation<
    PublishAllClassworkMaterialsOfTheCourseMutation,
    PublishAllClassworkMaterialsOfTheCourseMutationVariables
  >(PublishAllClassworkMaterialsOfTheCourseDocument, options)
}
export type PublishAllClassworkMaterialsOfTheCourseMutationHookResult =
  ReturnType<typeof usePublishAllClassworkMaterialsOfTheCourseMutation>
export type PublishAllClassworkMaterialsOfTheCourseMutationResult =
  Apollo.MutationResult<PublishAllClassworkMaterialsOfTheCourseMutation>
export type PublishAllClassworkMaterialsOfTheCourseMutationOptions =
  Apollo.BaseMutationOptions<
    PublishAllClassworkMaterialsOfTheCourseMutation,
    PublishAllClassworkMaterialsOfTheCourseMutationVariables
  >
...
export type FindQuizSubmitByIdQueryResult = Apollo.QueryResult<
  ...
  FindQuizSubmitByIdQueryVariables
>
export const PublishAllQuizOfTheCourseDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'PublishAllQuizOfTheCourse' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
...
export type PublishAllQuizOfTheCourseMutationFn = Apollo.MutationFunction<
  PublishAllQuizOfTheCourseMutation,
  PublishAllQuizOfTheCourseMutationVariables
>
export type PublishAllQuizOfTheCourseProps<
  TChildProps = {},
  TDataName extends string = 'mutate',
> = {
  [key in TDataName]: Apollo.MutationFunction<
...
export function withPublishAllQuizOfTheCourse<
  TProps,
  TChildProps = {},
  TDataName extends string = 'mutate',
>(
  operationOptions?: ApolloReactHoc.OperationOption<
    ...
    PublishAllQuizOfTheCourseMutation,
    PublishAllQuizOfTheCourseMutationVariables,
    PublishAllQuizOfTheCourseProps<TChildProps, TDataName>
  >,
) {
  return ApolloReactHoc.withMutation<
    TProps,
    ...
    PublishAllQuizOfTheCourseMutationVariables,
    PublishAllQuizOfTheCourseProps<TChildProps, TDataName>
  >(PublishAllQuizOfTheCourseDocument, {
    alias: 'publishAllQuizOfTheCourse',
    ...operationOptions,
  })
}

/**
 * __usePublishAllQuizOfTheCourseMutation__
 *
 * To run a mutation, you first call `usePublishAllQuizOfTheCourseMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `usePublishAllQuizOfTheCourseMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [publishAllQuizOfTheCourseMutation, { data, loading, error }] = usePublishAllQuizOfTheCourseMutation({
 *   variables: {
 *      courseId: // value for 'courseId'
 *   },
 * });
 */
export function usePublishAllQuizOfTheCourseMutation(
  baseOptions?: Apollo.MutationHookOptions<
    PublishAllQuizOfTheCourseMutation,
    PublishAllQuizOfTheCourseMutationVariables
  >,
  ...
  return Apollo.useMutation<
    PublishAllQuizOfTheCourseMutation,
    PublishAllQuizOfTheCourseMutationVariables
  >(PublishAllQuizOfTheCourseDocument, options)
}
export type PublishAllQuizOfTheCourseMutationHookResult = ReturnType<
  typeof usePublishAllQuizOfTheCourseMutation
>
export type PublishAllQuizOfTheCourseMutationResult =
  Apollo.MutationResult<PublishAllQuizOfTheCourseMutation>
export type PublishAllQuizOfTheCourseMutationOptions =
  Apollo.BaseMutationOptions<
    PublishAllQuizOfTheCourseMutation,
    PublishAllQuizOfTheCourseMutationVariables
  >
