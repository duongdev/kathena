...
export type CreateClassworkAssignmentMutation = {
  createClassworkAssignment: Pick<
    ClassworkAssignment,
    'id' | 'orgId' | 'createdAt' | 'courseId' | 'title' | 'type' | 'description'
  >
}
...
>
export type CreateClassworkAssignmentMutationResult = Apollo.MutationResult<CreateClassworkAssignmentMutation>
export type CreateClassworkAssignmentMutationOptions = Apollo.BaseMutationOptions<
  CreateClassworkAssignmentMutation,
  CreateClassworkAssignmentMutationVariables
>
